...
import 'package:anuncia_mi_llegada/presentation/widgets/icons/record_icon.dart';
...
class _RecordScreenState extends State<RecordScreen> {
  ...
  Future<void> _resendMessage(RecordItems record) async {
              ...
              Positioned(
                ...
                child: Column(
                  children: [
                    ...
                    //Historial
                    Expanded(
                      child: ValueListenableBuilder<List<RecordItems>>(
                        valueListenable: PreferencesService.recordList,
                        builder: (context, records, _) {
                          final filteredList = selectCategory == 'TODOS'
                              ? records
                              : records
                                    .where(
                                      (item) => item.category.contains(
                                        selectCategory,
                                      ),
                                    )
                                    .toList();
                              ...
                              return Padding(
                                ...
                                child: Material(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () => _resendMessage(record),
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        const Icon(Icons.chat_bubble_outline_rounded, color: Color(0xFFF69346), size: 26),
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children:[
                                              ...
                                              Text(
                                                record.transportAndLineName, style: AppTheme.nunitoFamilySubtitle,
                                              )
                                            ],
                                          )
                                        )
